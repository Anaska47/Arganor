...
export const DEFAULT_PROMPT_VERSIONS: PromptSeed[] = [
    {
        ...
        prompt_body: [
            ...
            "Priorise d'abord les sujets imperfections / peau grasse / niacinamide / bha, puis pousse cheveux / cuir chevelu / romarin / ricin, puis hydratation / peau seche / glow / acide hyaluronique / snail mucin.",
    ...
    },
    {
        ...
        prompt_body: [
            ...
            "Bloque si le produit n'est pas bien relie au besoin, si le cluster ou la categorie sont incoherents, si le CTA est faible, ou si le texte ressemble encore a un plan.",
